...
import com.controller.PaypPalNuevo;
...
public final class OAuthTokenCredential implements ICredential {
	...
	private static final Logger log = Logger.getLogger(OAuthTokenCredential.class.getName());
	...
	public OAuthTokenCredential(String clientID, String clientSecret) {
		...
		log.info(ConfigManager.getInstance().toString());
		log.info(ConfigManager.getInstance().getConfigurationMap().toString());
