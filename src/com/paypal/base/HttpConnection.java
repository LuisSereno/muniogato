...
public abstract class HttpConnection {
	...
	public String execute(String url, String payload,
		...
		if (headers != null) {
			...
			log.info("curl -v '" + connection.getURL().toString() + "' \\");
				...
				try {
					...
					try {
						...
						if (connection.getErrorStream() != null) {
							...
							log.warning("Error code : " + responsecode
						...
						lastException = ex;
						log.warning("Caught exception while handling error response" +  ex);
					}
				}
				retry++;
				if (retry > 0) {
					log.warning(" Retry  No : " + retry + "...");
