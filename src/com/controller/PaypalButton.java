...
public class PaypalButton extends HttpServlet implements Serializable{
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	try{
			...
			if ("DETALLE".equals(tipoPay)){
				...
				String button;
				button = manager.getButton(total, "es");
				salida=gson.toJson (button);
			}else{
				if (total>0){
		    		...
		    		//Para insertar el elemento, tendremos que recuperar el número de la factura que tenemos que aplicar. Introducirlo en la sesion, para almacenar el correo en el.
	...
	private String botonFacturaCorreo(HttpSession sesion, float total,	List<String> cadenaErrores, Gson gson, 
		...
		try {
			...
			//Necesitamos coger el numero de la factura. Para ello creamos los correos vacios, asignamos las facturas a esos correos, y le añadimos luego los textos.
   ...
   private String cadenaFactura(int numFactura,HttpSession sesion){
    	...
    	primeraParteFactura="<!DOCTYPE html PUBLIC '-//W3C//DTD HTML 4.01 Transitional//EN' 'http://www.w3.org/TR/html4/loose.dtd'>"+
				...
				"</head>"+
				"<body>"+
				"	<div style='text-align: center;'><big><big><big>FACTURA Nº "+ numeroFactura+"</big></big></big>"+
				"	<br>"+
				"	<br>"+
				...
				"		<img style='width: 270px; height: 208px;' src=\'cid:logotipo\'	alt='' align='top'>"+
				"		<br>"+
				"		<br>"+
				"		<br>"+
				"		FECHA:"+fechaActual +
